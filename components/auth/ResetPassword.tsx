            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-muted/40 backdrop-blur-xl border border-border/50 rounded-2xl p-8 shadow-2xl shadow-[#135bec]/10">
                    {success ? (
                        ...
                        <>
                            <h2 className="text-2xl font-semibold text-foreground mb-6">Set New Password</h2>
                            <form onSubmit={handleSubmit} className="space-y-5">

                                {/* Current Password */}
                                <div>
                                    <label htmlFor="current-password" className="block text-sm font-medium text-foreground/90 mb-2">
                                        Current Password
                                    </label>
                                    <input
                                        id="current-password"
